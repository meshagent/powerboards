...
class _MeshagentThreadViewState extends State<MeshagentThreadView> {
  ...
  void _open(String path) {
    ...
    updatedQueryParameters.remove(
      'pane',
    ); // remove the pane parameter to ensure file is shown
...
class MeshagentThreadListPane extends StatefulWidget {
  ...
  final ValueChanged<String?> onSelectedThreadPathChanged;
  final void Function(String? path, String? displayName)?
...
class MeshagentInlineThreadCreatePrompt extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const desktopActionButtonPadding = EdgeInsets.symmetric(
      horizontal: _desktopThreadListHorizontalPadding,
      vertical: 8,
    );
                  ...
                  child: InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          const SizedBox(
                            width: _desktopThreadContentAlignmentOffset,
                          ),
                          threadIcon,
                          ...
                          Expanded(
                            child: Text(
                              ...
                              style:
                                  _MeshagentThreadListPaneState.createActionStyle(
                                    context,
                                  ),
                            ),
                          ),
      ...
      itemBuilder: (context, index) {
        ...
        return _ThreadListItem(
          ...
          onOpen: () {
            ...
            widget.onSelectedThreadResolved?.call(
              entry.path,
              entry.displayName,
            );
          },
        ...
        child: ShadButton.ghost(
          ...
          leading: Padding(
            padding: const EdgeInsets.only(
              left: _desktopThreadContentAlignmentOffset,
            ),
...
class _ThreadListEmptyHint extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final leadingInset =
        (isMobile
            ? 12.0
            : _desktopThreadListHorizontalPadding +
                  _desktopThreadContentAlignmentOffset) +
