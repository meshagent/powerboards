...
class PbMenuOption extends StatefulWidget {
  const PbMenuOption({
    ...
    this.onPressed,
         ...
         leadingIconAssetName == null || leadingInitials == null,
         'Use either a leading icon or leading initials.',
       );
...
class _PbMenuOptionState extends State<PbMenuOption> {
  ...
  bool get _isHoveredState =>
      _resolvedState == PbMenuOptionVisualState.hovered ||
      _resolvedState == PbMenuOptionVisualState.pressed;
  ...
  Widget build(BuildContext context) {
    final backgroundColor = widget.infoSelected
        ...
        ? PbColors.surfaceAccentSoft
        : Colors.transparent;
    final borderColor = _isPressedState
    ...
    return MouseRegion(
      cursor: _interactive && !_disabled
          ? SystemMouseCursors.click
          : MouseCursor.defer,
      onEnter: _interactive && widget.state == null
          ? (_) => setState(() => _isPointerHovered = true)
          : null,
      ...
      child: GestureDetector(
        ...
        onTapDown: _interactive && !_disabled && widget.state == null
            ? (_) => setState(() => _isPointerPressed = true)
            : null,
        onTapUp: _interactive && !_disabled && widget.state == null
            ...
            : null,
        onTapCancel: _interactive && !_disabled && widget.state == null
            ? () => setState(() => _isPointerPressed = false)
            : null,
        child: Opacity(
          ...
          child: Container(
            ...
            padding: EdgeInsets.symmetric(
              horizontal: 16,
              vertical: widget.singleLine ? 0 : 14,
            ),
            ...
            child: Row(
              children: [
                if (widget.leadingIconAssetName != null ||
                    widget.leadingInitials != null) ...[
                  SizedBox(
                    ...
                    child: Center(
                      child: widget.leadingIconAssetName != null
                          ? AnimatedRotation(
                              ...
                              child: PbSvgIcon(
                                assetName: widget.leadingIconAssetName!,
                ...
                Expanded(
                  child: Column(
                    mainAxisAlignment: widget.singleLine
                    ...
                    children: [
                      Text(
                        widget.title,
                        style: PowerboardsTypography.menuTitle.copyWith(
                          color: titleColor,
                        ),
                        maxLines: 1,
                        softWrap: false,
                      ...
                      if (!widget.singleLine && widget.subtitle != null) ...[
                        ...
                        Text(
                          widget.subtitle!,
                          style: PowerboardsTypography.menuSubtitle.copyWith(
                            color: subtitleColor,
                          ),
                          maxLines: 1,
                          softWrap: false,
                ...
                if (widget.trailingIconAssetName != null) ...[
                  const SizedBox(width: 12),
                  PbSvgIcon(
                    assetName: widget.trailingIconAssetName!,
