...
class _PbMenuFilterFieldState extends State<PbMenuFilterField> {
  ...
  Widget build(BuildContext context) {
    ...
    final boxShadow = focused
        ? const [
            BoxShadow(
              color: Color.fromRGBO(199, 216, 255, 0.36),
              blurRadius: 0,
              spreadRadius: 3,
            ),
            BoxShadow(
    ...
    return MouseRegion(
      ...
      onEnter: widget.hovered == null
          ? (_) => setState(() => _hovered = true)
          : null,
      onExit: widget.hovered == null
      ...
      child: Transform.translate(
        ...
        child: Container(
          ...
          child: TextField(
            ...
            style: PowerboardsTypography.menuFilterText,
            decoration: InputDecoration(
              isCollapsed: true,
              border: InputBorder.none,
              hintText: widget.placeholder,
              hintStyle: PowerboardsTypography.menuFilterPlaceholder,
            ),
          ),
        ),
      ),
