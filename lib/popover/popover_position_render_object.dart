...
final class PopoverPositionRenderObject extends RenderShiftedBox {
  ...
  Offset calculateOffset(Size size) {
    ...
    if (pDirection == PopoverDirection.top || pDirection == PopoverDirection.bottom) {
      return _dxOffset(pDirection, _horizontalOffset(size), size);
    } else {
      return _dyOffset(pDirection, _verticalOffset(size), size);
    }
  }
  ...
  Offset _dxOffset(PopoverDirection direction, double horizontalOffset, Size size) {
  ...
  Offset _dyOffset(PopoverDirection pDirection, double verticalOffset, Size size) {
    if (pDirection == PopoverDirection.right) {
