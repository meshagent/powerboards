...
Widget _buildMenuHarness({
  required ShadContextMenuController firstController,
  required ShadContextMenuController secondController,
}) {
  return ShadApp(
    home: Scaffold(
      body: Row(
        children: [
          AdaptiveShadContextMenu(
            ...
            items: const [
              ShadContextMenuItem(height: 40, child: Text('First menu')),
            ],
          ...
          AdaptiveShadContextMenu(
            ...
            items: const [
              ShadContextMenuItem(height: 40, child: Text('Second menu')),
            ],
            child: const SizedBox(
              width: 80,
              height: 40,
...
void main() {
  testWidgets('opening one adaptive menu closes another open sibling menu', (
    tester,
  ) async {
  ...
  testWidgets(
    'opening an adaptive menu closes an open coordinated menu from meshagent_flutter_shadcn',
    (tester) async {
              ...
              children: [
                CoordinatedShadContextMenu(
                  ...
                  items: const [
                    ShadContextMenuItem(
                      height: 40,
                      child: Text('Coordinated menu'),
                    ),
                  ],
                  child: const SizedBox(
                    width: 80,
                    height: 40,
                    child: Text('Coordinated trigger'),
                  ),
                ),
                AdaptiveShadContextMenu(
                  ...
                  items: const [
                    ShadContextMenuItem(
                      height: 40,
                      child: Text('Adaptive menu'),
                    ),
                  ],
                  child: const SizedBox(
                    width: 80,
                    height: 40,
                    child: Text('Adaptive trigger'),
                  ),
                ),
              ],
            ),
